...
const styles: Record<string, React.CSSProperties> = {
  ...
  topBar:  { height: 48, display: 'flex', alignItems: 'center', paddingLeft: 20, borderBottom: '1px solid #1e1e1e', flexShrink: 0 },
  logo:    { fontSize: 16, fontWeight: 700, color: '#fff', letterSpacing: 0.5 },
  body:    { flex: 1, overflowY: 'auto', padding: '36px 40px', WebkitAppRegion: 'no-drag' as never },
  heading: { fontSize: 22, fontWeight: 700, color: '#fff', marginBottom: 24 },

  grid:    { display: 'flex', flexWrap: 'wrap', gap: 20 },

  card:    { width: 180, cursor: 'pointer', display: 'flex', flexDirection: 'column', gap: 8 },
  cardHovered: { },

  thumb:   { width: 180, height: 101, borderRadius: 8, overflow: 'hidden', background: '#1a1a1a', position: 'relative', border: '1px solid #2a2a2a' },
  ...
  plusIcon:  { fontSize: 32, color: '#444', lineHeight: 1 },
  ...
  cardLabel: { fontSize: 13, color: '#ddd', fontWeight: 500, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' },
  cardDate:  { fontSize: 11, color: '#555' },

  newInput:    { background: '#1e1e1e', border: '1px solid #444', color: '#fff', fontSize: 13, padding: '4px 8px', borderRadius: 5, outline: 'none', width: '100%', boxSizing: 'border-box' },
  renameInput: { background: '#1e1e1e', border: '1px solid #444', color: '#fff', fontSize: 13, padding: '2px 6px', borderRadius: 4, outline: 'none', width: '100%', boxSizing: 'border-box' },
}
