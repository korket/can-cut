...
const styles: Record<string, React.CSSProperties> = {
  ...
  modal: { background: '#1e1e1e', border: '1px solid #333', borderRadius: 10, padding: 24, width: 380, display: 'flex', flexDirection: 'column', gap: 16 },
  ...
  select: { background: '#2a2a2a', border: '1px solid #444', color: '#fff', padding: '6px 10px', borderRadius: 6, fontSize: 13 },
  exportBtn: { background: '#e63950', border: 'none', color: '#fff', padding: '10px', borderRadius: 7, cursor: 'pointer', fontSize: 14, fontWeight: 700 },
  progressWrap: { display: 'flex', alignItems: 'center', gap: 10 },
  progressBar: { flex: 1, height: 8, background: '#333', borderRadius: 4, overflow: 'hidden' },
  progressFill: { height: '100%', background: '#e63950', transition: 'width 0.2s' },
  progressLabel: { fontSize: 12, color: '#aaa', minWidth: 30 },
  success: { display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 10 },
  successIcon: { fontSize: 40, color: '#2abf5a' },
  successText: { fontSize: 16, fontWeight: 600, color: '#fff' },
  successPath: { fontSize: 11, color: '#666', wordBreak: 'break-all', textAlign: 'center' },
  openBtn: { background: '#2a2a2a', border: '1px solid #444', color: '#ccc', padding: '6px 16px', borderRadius: 6, cursor: 'pointer', fontSize: 13 },
  doneBtn: { background: '#e63950', border: 'none', color: '#fff', padding: '6px 20px', borderRadius: 6, cursor: 'pointer', fontSize: 13, fontWeight: 600 },
  error: { display: 'flex', flexDirection: 'column', gap: 8 },
  errorText: { fontSize: 14, color: '#f66', fontWeight: 600 },
  errorDetail: { fontSize: 12, color: '#888', wordBreak: 'break-all' },
  retryBtn: { background: '#2a2a2a', border: '1px solid #444', color: '#ccc', padding: '6px 14px', borderRadius: 6, cursor: 'pointer', fontSize: 12, alignSelf: 'flex-start' }
}
